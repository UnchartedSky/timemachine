...
function extracted(fbApp, defaultUrl, response) {
...
listPosts = function (request, response) {
    ...
    var fbApp = FB.extend({appId: config.facebook.appId, appSecret: config.facebook.appSecret});
